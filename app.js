class Producto {
  ...
  class BaseDeDatos {
    constructor() {
      ...
      this.agregarRegistro(1, "Docena de empanadas", 2100, "Alimentos", "docena.jpg");
      this.agregarRegistro(2, "Una empanada", 200, "Alimentos", "empanada.jpg");
      this.agregarRegistro(3, "Gaseosa", 700, "bebida", "gaseosa.jpg");
      this.agregarRegistro(4, "Cerveza Corona", 1000, "bebida", "corona.jpg");
      this.agregarRegistro(6, "Cerveza 420", 1200, "bebida", "420.jpg");
    }
